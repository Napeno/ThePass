...
const riddles = [
    // ["I am endless, and once you have me, you are bound for life. What am I?", "Marriage"],
    ["A man is sitting in a bar when a rich man sits next to him. He turns to the rich man and says: 'Did you know I know almost every song that has ever existed?' The rich man laughs. The man then says, 'I bet you all the money you have in your wallet that I can sing a genuine song with a ladys name of your choice in it'. The rich man laughs again and says, 'OK, how about my daughter’s name, Rochelle Maureen Fernandes?' Minutes later, the man collects his cash and the rich man goes home cashless. What song did the man sing?", "happybirthday"],
...
export default class RuleRiddle extends Rule{
    constructor(){
        super("Your gift must contain the solution to the following riddle:");
